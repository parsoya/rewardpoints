<?php
namespace BkdRwd\Entity\Repository;
...
class ProductRepository extends EntityRepository
{
    ...
    {
//        $dql = "SELECT b, e, r, p FROM \BkdRwd\Entity\User b JOIN b.engineer e ".
...
//        return $query->getArrayResult();
    ...
    public function getProductForEdit($artcId)
    {
//        $dql = "SELECT b, e, r FROM \Application\Entity\Bug b JOIN b.engineer e JOIN b.reporter r ".
//               "WHERE b.status = 'OPEN' AND e.id = ?1 OR r.id = ?1 ORDER BY b.created DESC";
        $dql = "SELECT c, u, l, a FROM BkdRwd\Entity\Product c LEFT JOIN c.author u LEFT JOIN c.language l LEFT JOIN c.program a WHERE c.id = ?1";

        $products = $this->getEntityManager()->createQuery($dql)
