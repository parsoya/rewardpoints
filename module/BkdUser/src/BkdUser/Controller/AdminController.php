...
class AdminController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        $users = $this->getEntityManager()->getRepository('BkdUser\Entity\User')->findall();
    ...
    public function createUserAction()
    {
        ...
        $viewModel->setTemplate('bkd-user/admin/new-user-form');
        return $viewModel;
    }
    ...
    public function editUserAction()
    {
        ...
        try {
            ...
            $entityManager = $this->getEntityManager();
            $user = $entityManager->getRepository('BkdUser\Entity\User')->find($id);
        ...
        $viewModel->setTemplate('bkd-user/admin/edit-user-form');
        return $viewModel;
    }
    ...
    public function setUserStateAction()
    {
        ...
        try {
            $entityManager = $this->getEntityManager();
            $user = $entityManager->getRepository('BkdUser\Entity\User')->find($id);
            $user->setState($entityManager->find('BkdUser\Entity\State', $state));
            $entityManager->persist($user);
            $entityManager->flush();
            $this->flashMessenger()->addSuccessMessage($this->getTranslatorHelper()->translate('User Updated Successfully'));
        }
