 ...
 * 
 * @ORM\Entity(repositoryClass="BkdUser\Entity\Repository\UserRepository")
 * @ORM\Table(name="`user`",
...
class User
{
    ...
    /**
    * @var BkdUser\Entity\Language
    *
    * @ORM\ManyToOne(targetEntity="BkdUser\Entity\Language")
    ...
    *   "target_class":"BkdUser\Entity\Language",
    *   "property": "name"
    * })
    */
    protected $language;
    ...
    /**
     * @var BkdUser\Entity\State
     *
     * @ORM\ManyToOne(targetEntity="BkdUser\Entity\State")
     ...
     *   "target_class":"BkdUser\Entity\State",
     *   "property": "state"
     * })
     */
    protected $state;
    ...
    /**
     * @var BkdUser\Entity\Question
     *
     * @ORM\ManyToOne(targetEntity="BkdUser\Entity\Question")
     ...
     *   "target_class":"BkdUser\Entity\Question",
     *   "property": "question"
     * })
     */
    protected $question;
     ...
     * @return User
     */
    public function addMyFriend(\BkdUser\Entity\User $user)
    {
     ...
     * @return User
     */
    public function removeMyFriend(\BkdUser\Entity\User $user)
    {
     ...
     * @return User
     */
    public function addFriendWithMe(\BkdUser\Entity\User $user)
    {
     ...
     * @return User
     */
    public function removeFriendWithMe(\BkdUser\Entity\User $user)
    {
